...
{
    private IGenericRepository<Quiz, int> quizRepository = new MemoryGenericRepository<Quiz, int>(new IntGenerator()); //transient
    private IGenericRepository<QuizItem, int> itemRepository = new MemoryGenericRepository<QuizItem, int>(new IntGenerator()); // singletony dla interfejsow ale wskazac implementacje wmemory generic repo
    ...
    // jak poprawnie zaimplementujesz to do seeddata, utworzyc quizitem do jedngo repo potem do drugiego
    //
